...
function gerarNumeroAleatorio() {
    let NumeroEscolhido = parseInt(Math.random() * NumeroLimitador + 1);
    let QuantidadeElementarDaLista =ListaDeNumerosSecretos.length

    if (QuantidadeElementarDaLista == NumeroLimitador) {
